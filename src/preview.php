...
$IP						=		"/mnt/data/uploads/".$_SERVER['REMOTE_ADDR'].time();
$cont						=		"";
$case						=		"";
$control					=		"";
...
if($method != "2")  { 
	...
	$IP				=	"/mnt/data/uploads/".$_POST['folder_id'];
}
...
if(isset($_POST["preprocess"])) {
	switch ($_POST['preprocess']){
		...
		case 2:
			...
			$norm_method_name	=		"Quantile";
			break;
		case 3:
			$norm_method		=		"preprocessIllumina";
			$norm_method_name	=		"IlluminaGenomeStudio";
			break;
		case 4:
			$norm_method		=		"preprocessNoob";
			$norm_method_name	=		"NOOB";
			break;
		case 5:
			$norm_method		=		"preprocessSWAN";
			$norm_method_name	=		"SWAN";
			break;
		case 6:
			$norm_method		=		"preprocessFunnorm";
			$norm_method_name	=		"Functional";
			break;
		case 7:
			$norm_method		=		"BMIQ";
			$norm_method_name	=		"BMIQ";
			break;
		case 8:
			$norm_method		=		"PBC";
			$norm_method_name	=		"PBC";
			break;
	}	
}
